...
class Booking extends Component {
  ...
  handleChange = (event) => {
    this.setState({
      selectOptions: { [event.target.name]: event.target.value },
    });
  };
  handleClose = (e) => {
                ...
                <div className="selectForm booking-right-top">
                  ...
                  <div className="booking-main">
                    <select
                      ...
                      value={this.state.selectOptions["category"]}
                    >
                    ...
                    <select
                      name="reason"
                      onChange={this.handleChange}
                      value={this.state.selectOptions["reason"]}
                    >
                    ...
                    <select
                      name="doctor"
                      onChange={this.handleChange}
                      value={this.state.selectOptions["doctor"]}
                    >
              ...
              {this.state.currentForm === 3 && (
                <div className="selectForm booking-right-top">
                  ...
                  <div className="booking-main">
                    ...
                    <p>
                      Thanks for booking you now have an appointment with Dr
                      Nicholas at 10 AM
                    </p>
                  </div>
                </div>
